...
#-------------------------------------------------------------------------------
from params import dim,make_movie,vel_data,delta,eps_w,eps_beta,save_sol,load_sol
...
# noise = norm(h_obs-h_true)/norm(h_obs)
#
# misfit_arr = np.zeros(7)
# eps_arr = np.zeros(7)
#
